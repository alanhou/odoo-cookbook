...
class IrHttp(models.AbstractModel):
    ...
    @http.route('/my_hostel/all-students/group_user', type='http',
                auth='base_group_user')
    def all_students_mine_base_group_user(self):
        # your code
        return ...

    # this is for the exercise
    @http.route('/my_hostel/all-students/groups', type='http',
                auth='groups(base.group_no_one)')
    def all_students_mine_groups(self):
        # your code
        return ...